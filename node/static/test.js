...
(function($PS) {
  ...
  var loadMsgs$prime = function (mData) {
      return function (cb) {
          return SimpleJquery_SimpleJquery.ajax("/api/get")(SimpleJquery_SimpleJquery.GET.value)(mData)(function (a) {
              ...
              throw new Error("Failed pattern match at FrontendMain (line 65, column 5 - line 67, column 55): " + [ v.constructor.name ]);
          });
      };
  };
      ...
      return function (msgTpl) {
          return function __do() {
              ...
              return loadMsgs$prime(Data_Maybe.Nothing.value)(function (msgs) {
                  return function __do() {
                      JQuery.clear(container)();
                      var v = Data_Function.flip(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect))(msgs)(function (msg) {
                          return function __do() {
                              var v = JQuery.clone(msgTpl)();
                              JQuery.setHtml(msg.msg)(v)();
                  ...
                  return SimpleJquery_SimpleJquery.ajax("/api/msg")(SimpleJquery_SimpleJquery.POST.value)(new Data_Maybe.Just(v))(function (a) {
                      ...
                      if (v1 instanceof Data_Either.Right) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at FrontendMain (line 44, column 9 - line 46, column 48): " + [ Data_Unit.unit.constructor.name ]);
                          };
                      };
                      ...
                      throw new Error("Failed pattern match at FrontendMain (line 41, column 5 - line 47, column 55): " + [ v1.constructor.name ]);
                  })();
              };
          };
      };
